...
static std::array<double, 3> upwind_difference_3d(const Map<3> &map, const Map<3>::index_t &index) {
...
static std::array<double, 2> upwind_difference_2d(const Map<2> &map, const Map<2>::index_t &index) {
  const auto num_points = map.get_num_points();
...
static std::array<double, 3> central_difference_3d(const Map<3> &map,
                                                   const Map<3>::index_t &index) {
  const auto num_points = map.get_num_points();
...
static std::array<double, 2> central_difference_2d(const Map<2> &map,
                                                   const Map<2>::index_t &index) {
  const auto num_points = map.get_num_points();
...
static std::array<Map<3>, 3> df_3d(const Map<3> &map, const DerivativeType &type) {
  const auto num_points = map.get_num_points();
...
static std::array<Map<2>, 2> df_2d(const Map<2> &map, const DerivativeType &type) {
  const auto num_points = map.get_num_points();
