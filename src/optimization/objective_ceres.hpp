...
struct ObjectiveFunctorCeres {
  ...
  ObjectiveFunctorCeres(const MapArgs<Dim> &map_args,
  ...
  bool compute_residuals_(const Eigen::VectorXd &x, Eigen::VectorXd &residuals) const;
